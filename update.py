#!/usr/bin/env python3
"""GUI fix - dogrudan app/main.py gunceller"""
import os

# Nerede oldugumuzu bul
SCRIPT_DIR = os.path.dirname(os.path.abspath(__file__))
print(f"Script konumu: {SCRIPT_DIR}")

# app/main.py yolunu belirle
MAIN_PATH = os.path.join(SCRIPT_DIR, "app", "main.py")
print(f"Hedef dosya: {MAIN_PATH}")

# app klasoru var mi?
app_dir = os.path.join(SCRIPT_DIR, "app")
if not os.path.exists(app_dir):
    print(f"HATA: app klasoru bulunamadi: {app_dir}")
    print("Lutfen steel_heat_treatment_adv klasorunde oldugunuzdan emin olun")
    exit(1)
...
print(f"✅ Basariyla guncellendi: {MAIN_PATH}")
print("\nSimdi calistirin:")
